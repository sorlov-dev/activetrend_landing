document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            contact_lead: "ActiveTrend is reachable by email. This is also the support address for the ActiveTrend app.",
            ...
            contact_support_p: "Problems with the ActiveTrend app, bug reports, questions about your data and how to delete it, and refund or subscription questions.",
            ...
            contact_press_p: "Media requests, product information and press material for ActiveTrend.",
            contact_details_title: "Business details",
            privacy_policy: "Privacy Policy",
            app_privacy: "App Privacy Policy",
        ...
        es: {
            ...
            contact_lead: "Puedes comunicarte con ActiveTrend por correo electrónico. Esta es también la dirección de soporte de la app ActiveTrend.",
            contact_response: "Escríbenos en español, inglés o ruso. Procuramos responder dentro de los 3 días hábiles.",
            contact_what_title: "Sobre qué puedes escribirnos",
            contact_support_h: "Soporte de la app",
            contact_support_p: "Problemas con la app ActiveTrend, reportes de errores, consultas sobre tus datos y cómo eliminarlos, y consultas sobre reembolsos o suscripciones.",
            contact_business_h: "Negocios",
            contact_business_p: "Consultas sobre alianzas, distribución y otros temas comerciales, además de consultas de plataformas y proveedores de pago sobre el estudio.",
            contact_press_h: "Prensa",
            contact_press_p: "Solicitudes de medios, información de producto y material de prensa sobre ActiveTrend.",
            contact_details_title: "Datos comerciales",
            privacy_policy: "Política de Privacidad",
            app_privacy: "Política de Privacidad de la App",
